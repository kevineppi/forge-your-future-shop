              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <AnimatedSection animation="fade-in">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 mb-10">
                    ...
                    <Button asChild size="lg" variant="outline" className="group"><Link to="/messemodelle">Alle Infos<ArrowRight className="ml-2 w-4 h-4 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200" /></Link></Button>
                  </div>
          ...
          <section key="di" className="py-20 md:py-28 relative overflow-hidden bg-muted/30">
            <div className="container mx-auto px-4 relative">
              <AnimatedSection animation="fade-in" className="max-w-4xl mx-auto text-center">
                ...
                <Button asChild size="lg" className="shadow-lg"><Link to="/kontakt">Jetzt Anfrage stellen<ArrowRight className="ml-2 w-5 h-5" /></Link></Button>
              </AnimatedSection>
            </div>
          </section>
        );
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-5xl mx-auto">
                {nearbyRegions.map((nearby, i) => (
                  <AnimatedSection key={nearby.slug} animation="slide-up" delay={i * 75}>
                    <Link to={`/messemodelle/${nearby.slug}`} className="group block" onClick={() => window.scrollTo(0, 0)}>
