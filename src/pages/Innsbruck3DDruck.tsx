        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-12">
              Unsere <span className="text-gradient">Services in Innsbruck</span>
            </h2>
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="gradient-card p-6 rounded-xl">
                ...
                <p className="text-muted-foreground mb-4">
                  Professioneller FDM 3D-Druck für Prototypen, Einzelteile und Kleinserien in Innsbruck.
                </p>
              ...
              <div className="gradient-card p-6 rounded-xl">
                ...
                <p className="text-muted-foreground mb-4">
                  Benötigen Sie Ihr Teil schnell? Wir liefern innerhalb von 24 Stunden in ganz Innsbruck.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold mb-8 text-center">
                Warum ekdruck für <span className="text-gradient">Innsbruck</span>?
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex gap-4">
                  <CheckCircle className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold mb-2">Schnelle Lieferung nach Innsbruck</h3>
                    <p className="text-muted-foreground">Express-Versand innerhalb von 24h direkt zu Ihnen nach Innsbruck</p>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                Professioneller <span className="text-gradient">FDM 3D-Druck</span> für Innsbruck
              </h2>
              <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
                Modernste Technologie trifft auf österreichische Qualität – Ihr 3D-Druck Partner in Tirol.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-12 mb-16">
                <div>
                  ...
                  <p className="text-muted-foreground mb-4 leading-relaxed">
                    ...
                    bildet die Grundlage unseres Services in Innsbruck. Bei diesem additiven Fertigungsverfahren wird thermoplastisches 
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    bietet maximale Flexibilität für Ihre Projekte in Innsbruck.
                  </p>
                </div>
                
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold mb-6">Vorteile für Innsbrucker Unternehmen</h3>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          ...
                          in Start-ups und Forschungseinrichtungen in Innsbruck.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          ...
                          Filamente aus österreichischer Produktion – Made in Austria für Innsbruck.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid md:grid-cols-4 gap-6">
                ...
                <div className="text-center p-6 bg-card rounded-xl border">
                  ...
                  <p className="text-sm text-muted-foreground">Express-Lieferung nach Innsbruck</p>
                </div>
                <div className="text-center p-6 bg-card rounded-xl border">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-card p-6 rounded-xl border">
                  ...
                  <p className="text-muted-foreground">Funktionale Prototypen, Ersatzteile, Vorrichtungen und Betriebsmittel für Innsbrucker Industrieunternehmen</p>
                </div>
                <div className="bg-card p-6 rounded-xl border">
                  <h3 className="font-bold text-lg mb-3">🏗️ Architektur & Bau</h3>
                  <p className="text-muted-foreground">Architekturmodelle, Designstudien und Präsentationsmodelle für Tiroler Architekten und Planer</p>
                </div>
                <div className="bg-card p-6 rounded-xl border">
                  <h3 className="font-bold text-lg mb-3">🎨 Design & Kunst</h3>
                  <p className="text-muted-foreground">Kunstobjekte, Designprototypen und individuelle Einzelstücke für Innsbrucker Kreativschaffende</p>
                </div>
                <div className="bg-card p-6 rounded-xl border">
                  <h3 className="font-bold text-lg mb-3">🔬 Forschung & Entwicklung</h3>
                  <p className="text-muted-foreground">Rapid Prototyping für Universitäten, Forschungseinrichtungen und Start-ups in Innsbruck</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg mb-2">Lieferung nach Innsbruck</h3>
                    <p className="text-muted-foreground">Express-Versand innerhalb von 24-48h direkt zu Ihnen nach Innsbruck</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center gradient-card p-12 rounded-2xl">
              <h2 className="text-4xl font-bold mb-6">
                Starten Sie Ihr <span className="text-gradient">3D-Druck Projekt</span> in Innsbruck
              </h2>
              <p className="text-xl text-muted-foreground mb-8">
