          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Professioneller FDM 3D-Druck Service für Innsbruck und ganz Tirol. Schnelle Lieferung, nachhaltige Materialien und Top-Qualität aus Österreich.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="gradient-card p-6 rounded-xl">
                ...
                <p className="text-muted-foreground mb-4">
                  Präziser FDM 3D-Druck für Prototypen, Modelle und Funktionsteile in Innsbruck.
                </p>
              ...
              <div className="gradient-card p-6 rounded-xl">
                ...
                <p className="text-muted-foreground mb-4">
                  Schnelle Lieferung nach Innsbruck und in ganz Tirol - auch ins Gebirge.
                </p>
              ...
              <div className="gradient-card p-6 rounded-xl">
                ...
                <p className="text-muted-foreground mb-4">
                  Nachhaltige österreichische Filamente in Premium-Qualität.
                </p>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold mb-2">Zuverlässige Lieferung nach Innsbruck</h3>
                    <p className="text-muted-foreground">Express-Versand innerhalb von 24-48h in ganz Tirol</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <CheckCircle className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold mb-2">Technische Beratung auf Deutsch</h3>
                ...
                <div className="flex gap-4">
                  <CheckCircle className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold mb-2">Transparente & faire Preise</h3>
