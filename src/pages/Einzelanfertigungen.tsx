      ...
      <main className="pt-20">
        ...
        <section className="py-16 lg:py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold mb-6">Transparente Preisgestaltung</h2>
                <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                  Faire Preise für individuelle Lösungen - keine versteckten Kosten
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="border-0 shadow-card text-center">
                  <CardHeader>
                    ...
                    <CardDescription>Einfache Einzelanfertigungen</CardDescription>
                    <div className="text-3xl font-bold text-primary mt-4">ab €15</div>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <ul className="space-y-2 text-sm text-muted-foreground text-left">
                      <li>• Standard-Materialien (PLA, PETG)</li>
                      <li>• Einfache Geometrien</li>
                      <li>• Bestehende CAD-Datei</li>
                      <li>• Standardfarben</li>
                ...
                <Card className="border-0 shadow-card text-center border-primary/50">
                  <CardHeader>
                    <Badge className="mb-4">Beliebt</Badge>
                    <CardTitle className="text-2xl">Professional</CardTitle>
                    <CardDescription>Komplexe Einzelanfertigungen mit Service</CardDescription>
                    <div className="text-3xl font-bold text-primary mt-4">ab €45</div>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <ul className="space-y-2 text-sm text-muted-foreground text-left">
                      <li>• Alle Materialien verfügbar</li>
                      <li>• Komplexe Geometrien</li>
                      <li>• CAD-Modellierung inklusive</li>
                      <li>• Individuelle Farbanpassung</li>
                ...
                <Card className="border-0 shadow-card text-center">
                  <CardHeader>
                    ...
                    <CardDescription>Höchste Ansprüche & Express-Service</CardDescription>
                    <div className="text-3xl font-bold text-primary mt-4">ab €90</div>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <ul className="space-y-2 text-sm text-muted-foreground text-left">
                      <li>• High-End Materialien</li>
                      <li>• Höchste Präzision</li>
                      <li>• Design-Optimierung</li>
                      <li>• Mehrfarbige Drucke</li>
                      <li>• 24-48h Express-Service</li>
              ...
              <div className="text-center mt-8">
                <p className="text-sm text-muted-foreground">
                  * Endpreise abhängig von Größe, Materialverbrauch und Komplexität. 
                  <strong> Kostenloses Angebot binnen 24h garantiert!</strong>
                </p>
              </div>
            </div>
          </div>
