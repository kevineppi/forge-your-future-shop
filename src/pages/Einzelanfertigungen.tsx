  ...
  return (
    <>
      <SEOHead
        ...
        description="Individuelle Anschauungsmodelle für Messen, Architektur und Industriepräsentationen. Maßanfertigung aus Oberösterreich. Ab €20, Angebot in 6h, Express 24h, österreichweit."
                  ...
                  <Card key={i} className="border-2 hover:border-primary/50 hover:shadow-lg transition-all group">
                    <CardContent className="p-6">
                      ...
                      <div className="mt-4 pt-4 border-t border-border">
                        <Link to={uc.link} className="text-sm text-primary font-medium hover:underline inline-flex items-center gap-1">
