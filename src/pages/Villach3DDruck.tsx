  ...
  return (
    <>
      <SEOHead 
        ...
        description="Kärntens Tech-Hub Villach: Präzise Funktionsteile für Elektronik & Maschinenbau. Schnelle Lieferung, technischer Support bei komplexen Geometrien. Express 24-48h. Infineon-Projekt unterstützen lassen!"
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4 relative">
            <AnimatedSection className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
                Ihr lokaler Partner für professionellen FDM 3D-Druck in <strong className="text-foreground">Villach</strong> und ganz Kärnten Süd. 
                Schnelle Lieferung nach <strong className="text-foreground">Villach</strong>, nachhaltige Materialien und faire Preise für Ihre Projekte.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <AnimatedSection delay={0.2}>
                <div className="group gradient-card p-8 rounded-2xl hover-scale border-2 border-transparent hover:border-primary/20 transition-all duration-300">
                  ...
                  <p className="text-muted-foreground mb-6 leading-relaxed">
                    Benötigen Sie Ihr Teil schnell? Wir liefern innerhalb von 24-48 Stunden nach ganz Villach. 
            ...
            <div className="max-w-5xl mx-auto">
              <AnimatedSection>
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                  Warum ekdruck für <span className="text-gradient">3D-Druck in Villach</span>?
                </h2>
                <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
                  Als österreichischer 3D-Druck-Spezialist bieten wir Ihnen lokale Expertise, 
                  schnelle Lieferzeiten und persönliche Betreuung für Ihr Projekt in Villach.
                </p>
              </AnimatedSection>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <AnimatedSection delay={0.1}>
                  <div className="flex gap-4 p-6 bg-card rounded-xl border hover:border-primary/50 transition-colors">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-2">Schnelle Lieferung nach Villach</h3>
                      <p className="text-muted-foreground">Express-Versand innerhalb von 24-48h direkt zu Ihnen nach Villach. Standard-Lieferung in 2-3 Werktagen österreichweit.</p>
                    </div>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.2}>
                  <div className="flex gap-4 p-6 bg-card rounded-xl border hover:border-primary/50 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Keine langen Lieferwege aus dem Ausland. Direkt aus Österreich mit kurzen Kommunikationswegen und persönlichem Kontakt.</p>
                    </div>
                  </div>
                </AnimatedSection>
        ...
        {/* Villach Industry Section */}
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <AnimatedSection>
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                  3D-Druck für <span className="text-gradient">Villacher Unternehmen</span>
                </h2>
                <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
                  Villach ist ein bedeutender Industriestandort in Kärnten. Als lokaler 3D-Druck Dienstleister 
                  unterstützen wir die innovative Wirtschaft der zweitgrößten Stadt Kärntens.
                </p>
              </AnimatedSection>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <AnimatedSection delay={0.1}>
                  <div className="bg-card p-8 rounded-2xl border-2 hover:border-primary/30 transition-all">
                    ...
                    <h3 className="text-2xl font-bold mb-4">Industrie & Fertigung</h3>
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      Villach ist ein wichtiger Technologie- und Industriestandort. 
                      Unser <strong className="text-primary">3D-Druck Service</strong> unterstützt Unternehmen mit:
                    </p>
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                        <span>Funktionsprototypen für Produktentwicklungen</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                ...
                <AnimatedSection delay={0.2}>
                  <div className="bg-card p-8 rounded-2xl border-2 hover:border-primary/30 transition-all">
                    ...
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      Mit der FH Kärnten und zahlreichen F&E-Einrichtungen profitiert Villach von innovativen 3D-Druck-Lösungen. 
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <AnimatedSection>
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                  Anwendungsbereiche für <span className="text-gradient">3D-Druck in Villach</span>
                </h2>
                <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
                  Von der Industrie über Architektur bis zur Forschung – 3D-Druck bietet vielseitige Möglichkeiten 
                  für Unternehmen und Privatpersonen in Villach und Umgebung.
                </p>
              </AnimatedSection>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <AnimatedSection delay={0.1}>
                  <div className="bg-card p-6 rounded-2xl border-2 border-transparent hover:border-primary/30 transition-all hover-scale">
                    ...
                    <h3 className="font-bold text-xl mb-3">Industrie & Fertigung</h3>
                    <p className="text-muted-foreground leading-relaxed">
                      Funktionale Prototypen, Ersatzteile und Vorrichtungen für Villacher Industrieunternehmen.
                    </p>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.2}>
                  <div className="bg-card p-6 rounded-2xl border-2 border-transparent hover:border-primary/30 transition-all hover-scale">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Architekturmodelle und Präsentationsmodelle für Villacher Architekten und Planer.
                    </p>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.3}>
                  <div className="bg-card p-6 rounded-2xl border-2 border-transparent hover:border-primary/30 transition-all hover-scale">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Kunstobjekte, Designprototypen und individuelle Einzelstücke für Villacher Kreativschaffende.
                    </p>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.4}>
                  <div className="bg-card p-6 rounded-2xl border-2 border-transparent hover:border-primary/30 transition-all hover-scale">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Rapid Prototyping für FH Kärnten und Forschungseinrichtungen in Villach.
                    </p>
                  </div>
                </AnimatedSection>
              </div>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <AnimatedSection>
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                  <span className="text-gradient">Materialien</span> für Ihr Projekt in Villach
                </h2>
                <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
        ...
        <section className="py-20 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto">
              <AnimatedSection>
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                  So einfach geht <span className="text-gradient">3D-Druck in Villach</span>
                </h2>
                <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
                    ...
                    <div className="flex gap-6 items-start relative">
                      ...
                      <div className="flex-1 bg-card p-6 rounded-xl border-2 hover:border-primary/30 transition-all">
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                          ...
                          zu Ihnen nach Villach. Standard-Lieferung österreichweit in 2-3 Werktagen. Tracking-Nummer inklusive.
                        </p>
                      </div>
                    </div>
                  </AnimatedSection>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <AnimatedSection>
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-center">
                  Häufig gestellte <span className="text-gradient">Fragen</span> zum 3D-Druck in Villach
                </h2>
                <p className="text-center text-muted-foreground mb-12 max-w-3xl mx-auto text-lg">
                  Hier finden Sie Antworten auf die wichtigsten Fragen rund um unseren 3D-Druck Service in Villach.
                </p>
              </AnimatedSection>
                ...
                <Accordion type="single" collapsible className="space-y-4">
                  <AccordionItem value="item-1" className="bg-card border rounded-xl px-6">
                    <AccordionTrigger className="text-left font-bold text-lg hover:text-primary">
                      Wie schnell kann ich mein 3D-Druck-Teil in Villach erhalten?
                    </AccordionTrigger>
                    <AccordionContent className="text-muted-foreground leading-relaxed">
                      Mit unserem Express-Service liefern wir innerhalb von 24-48 Stunden nach Villach. Standard-Lieferungen dauern 2-3 Werktage. 
                      Für besonders dringende Projekte können wir auch schnellere Lösungen anbieten – kontaktieren Sie uns direkt.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-4" className="bg-card border rounded-xl px-6">
                    ...
                    <AccordionContent className="text-muted-foreground leading-relaxed">
                      ...
                      Finishing-Optionen für Ihre 3D-gedruckten Teile in Villach. So erhalten Sie produktionsreife Bauteile direkt einsatzbereit.
                    </AccordionContent>
                  </AccordionItem>

                  <AccordionItem value="item-5" className="bg-card border rounded-xl px-6">
                    <AccordionTrigger className="text-left font-bold text-lg hover:text-primary">
                      Welche Materialien eignen sich für technische Anwendungen?
                    </AccordionTrigger>
                    <AccordionContent className="text-muted-foreground leading-relaxed">
                      Für technische Anwendungen empfehlen wir ABS, ASA oder PA12 Nylon. Diese Materialien bieten hohe Festigkeit, 
                      Hitzebeständigkeit und sind ideal für mechanisch belastete Bauteile in Villacher Industrieunternehmen.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              </AnimatedSection>
