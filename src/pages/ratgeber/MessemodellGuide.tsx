          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button asChild variant="outline" size="lg">
                <Link to="/messemodelle">Messemodelle ansehen</Link>
              </Button>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-4xl space-y-16">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Besonders für <Link to="/messemodelle" className="text-primary hover:underline font-medium">Express-Messemodelle</Link> gibt es keine vergleichbare Alternative.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-5 flex gap-3">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  <Link to="/kontakt" className="text-primary hover:underline font-medium">Jetzt anfragen →</Link>
                </p>
              </div>
            </section>
            ...
            <section className="bg-primary/5 border border-primary/20 rounded-2xl p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button asChild variant="outline" size="lg">
                  <Link to="/messemodelle">Alle Messemodell-Infos</Link>
                </Button>
              </div>
            </section>
