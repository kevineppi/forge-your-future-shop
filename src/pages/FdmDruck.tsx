  ...
  return (
    <>
      <SEOHead 
        ...
        description="Warum Ingenieure FDM-Technologie lieben: Robuste Funktionsteile, breite Materialauswahl und unschlagbare Wirtschaftlichkeit. Von Prototyp bis Serie – entdecken Sie die Möglichkeiten. Jetzt Machbarkeit prüfen lassen!"
