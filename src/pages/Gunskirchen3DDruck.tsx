  ...
  return (
    <>
      <SEOHead 
        ...
        description="Direkt vom Hersteller: Persönliche Beratung, Muster-Besichtigung & Same-Day Abholung in Gunskirchen. Ihr lokaler 3D-Druck Partner. Jetzt Termin vereinbaren!"
