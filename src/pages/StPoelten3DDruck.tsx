  ...
  return (
    <>
      <SEOHead 
        ...
        description="Landeshauptstadt-Service für Niederösterreich: Bildungseinrichtungen & Verwaltung setzen auf uns. Express 24-48h nach St. Pölten. Beratung vor Ort möglich!"
