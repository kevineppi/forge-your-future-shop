...
const Linz3DDruck = () => {
  return <>
      ...
      <ServiceSchema serviceName="Rapid Prototyping 24h Express-Service Linz" description="Professioneller Rapid Prototyping Service für Linz mit FDM 3D-Druck. Express-Fertigung in 24-48h mit Lieferung nach Linz oder Same-Day Abholung in Gunskirchen (30km). Ideal für Start-ups, Industrie und Forschung." serviceType="Service" offers={{
      price: "50.00",
      priceCurrency: "EUR",
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <AnimatedSection delay={0.1}>
                  <div className="bg-card p-8 rounded-2xl border-2 hover:border-primary/30 transition-all">
                    ...
                    <p className="text-muted-foreground mb-4 leading-relaxed">
                      Linz ist ein kreativer Hotspot in Österreich. 
                      Unser <strong className="text-primary">3D-Druck Service</strong> unterstützt Kreative mit:
                    </p>
                    <ul className="space-y-2 text-muted-foreground">
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                        <span>Dekorationsobjekte und Wohnaccessoires</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                        <span>Kunstobjekte und Skulpturen</span>
                      </li>
                    </ul>
                  </div>
                </AnimatedSection>
              ...
              <AnimatedSection delay={0.2}>
                <Accordion type="single" collapsible className="space-y-4">
                  ...
                  <AccordionItem value="item-3" className="bg-card border rounded-xl px-6">
                    ...
                    <AccordionContent className="text-muted-foreground leading-relaxed">
                      Die Kosten hängen von Material, Größe, Komplexität und Druckdauer ab. Kontaktieren Sie uns für ein individuelles Angebot. Kleine Teile starten bereits ab €5, größere Projekte nach individueller Kalkulation.
                    </AccordionContent>
                  </AccordionItem>
