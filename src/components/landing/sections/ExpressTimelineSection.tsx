...
import { Zap, Clock, Package, Truck, ArrowRight, CheckCircle2 } from "lucide-react";
...
const ExpressTimelineSection = ({ regionName, deliveryTime }: ExpressTimelineSectionProps) => {
  const steps = [
    {
      time: '0h',
      icon: Zap,
      title: 'Anfrage senden',
      description: 'CAD-Datei oder Beschreibung per E-Mail oder Kontaktformular senden.',
      highlight: false,
    },
    {
      time: '6h',
      ...
      description: 'Persönliches Angebot mit Preis, Material und Liefertermin.',
      highlight: false,
    },
    {
      time: '12h',
      icon: Package,
      title: 'Fertigung startet',
      description: 'Nach Freigabe starten unsere Drucker sofort mit Ihrem Projekt.',
      highlight: true,
    },
    {
      time: '24h',
      icon: Truck,
      title: `In ${regionName}`,
      description: `Express-Versand: Morgen bei Ihnen in ${regionName}. Standard: ${deliveryTime}.`,
      highlight: true,
    },
  ];
