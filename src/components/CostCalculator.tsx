            ...
            <Card className="gradient-card border-0 animate-slide-up">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  {pricing.savings > 0 && (
                    <div className="flex justify-between items-center p-4 bg-green-500/10 rounded-lg border border-green-500/20 hover:bg-green-500/20 hover:border-green-500/30 transition-all duration-300 cursor-pointer">
                  ...
                  {quantity[0] >= 5 && (
                    <Badge className="w-full justify-center bg-green-500/10 text-green-600 border-green-500/20 hover:bg-green-500/20 hover:border-green-500/30 hover:text-green-700 transition-all duration-300 cursor-pointer">
                      🎉 Mengenrabatt aktiv!
                    </Badge>
                  )}
                </div>
