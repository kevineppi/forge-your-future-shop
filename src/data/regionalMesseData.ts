...
export const regionalMesseData: Record<string, RegionalMesseData> = {
  ...
  'salzburg': {
    ...
    metaTitle: 'Messemodelle Salzburg – Gastro & AutoSalon | ekdruck',
    metaDescription: 'Salzburger Aussteller: Standmodelle für Alles-für-den-Gast, AutoSalon & Bauen+Wohnen. A1-Expresslieferung ab OÖ. Angebot in 6h.',
  ...
  'linz': {
    ...
    metaTitle: 'Messemodelle Linz – Same-Day für Events | ekdruck',
    metaDescription: 'Linzer Kreativszene: Standmodelle für Design Center, Tabakfabrik & Ars Electronica. 20 Min entfernt, Same-Day möglich. Jetzt anfragen.',
  ...
  'graz': {
    ...
    metaTitle: 'Messemodelle Graz – Häuslbauer & Herbstmesse | ekdruck',
    metaDescription: 'Grazer Aussteller: Standmodelle für Häuslbauermesse, Herbstmesse & Frühjahrsmesse. Express über A9 direkt zur Messe Graz. Angebot in 6h.',
  ...
  'klagenfurt': {
    ...
    metaTitle: 'Messemodelle Klagenfurt – Holzmesse & Baumesse | ekdruck',
    metaDescription: 'Klagenfurter Aussteller: Standmodelle für Internationale Holzmesse & Kärntner Baumesse. Robuste Alpenlogistik über A10. Jetzt anfragen.',
  ...
  'villach': {
    ...
    metaTitle: 'Messemodelle Villach – Gewerbe & Tourismus-Events | ekdruck',
