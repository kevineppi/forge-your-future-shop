...
export const regionalMesseData: Record<string, RegionalMesseData> = {
  ...
  'wien': {
    ...
    metaTitle: 'Messemodelle Wien | In 24h am Stand ✓ Ab €20 | ekdruck',
    metaDescription: 'Messestand morgen? Wir liefern 3D-Messemodelle direkt zur Reed Messe Wien. Maßgefertigt, bruchsicher verpackt. Angebot in 6h – jetzt anfragen!',
  ...
  'niederoesterreich': {
    ...
    metaTitle: 'Messemodelle Niederösterreich | Express ab OÖ | ekdruck',
    metaDescription: 'Messemodelle für NÖ: Wieselburger Messe, AB HOF & regionale Events. Schnelle A1-Anbindung, Angebot in 6h. Ab €20 – jetzt anfragen!',
  ...
  'oberoesterreich': {
    ...
    metaTitle: 'Messemodelle OÖ | Abholung Gunskirchen ✓ | ekdruck',
    metaDescription: 'Lokaler Hersteller in Gunskirchen: Messemodelle für Welser Messe, AGRARIA & Power-Days. Same-Day möglich. Persönliche Übergabe – jetzt anfragen!',
