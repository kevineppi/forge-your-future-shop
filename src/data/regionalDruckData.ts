...
export const regionalDruckData: Record<string, RegionalDruckData> = {
  'wien': {
    ...
    name: 'Wien',
    type: 'stadt',
    title: '3D-Druck Wien – Firma & Anbieter',
    h1Title: '3D-Druck Wien – Ihre 3D-Druck Firma für Modelle & Prototypen',
    metaTitle: '3D-Druck Wien Firma & Anbieter | Service in 24h | ekdruck',
    metaDescription: '3D-Druck Wien ✓ Professioneller Anbieter & Dienstleister ✓ Modelle, Prototypen, Designstudien ✓ Express in 24h ✓ Ab €20 → Jetzt 3D-Druck Anfrage stellen',
  ...
  'linz': {
    ...
    name: 'Linz',
    type: 'stadt',
    title: '3D-Druck Linz – Firma & Anbieter',
    h1Title: '3D-Druck Linz – Ihr 3D-Druck Dienstleister für Same-Day Service',
    metaTitle: '3D-Druck Linz Firma | Same-Day Anbieter in 20 Min | ekdruck',
    metaDescription: '3D-Druck Linz ✓ Professionelle 3D-Druck Firma & Anbieter mit Same-Day Service ✓ Persönliche Abholung in 20 Min ✓ Modelle, Prototypen, Schulungsobjekte → Termin anfragen',
  ...
  'graz': {
    ...
    name: 'Graz',
    type: 'stadt',
    title: '3D-Druck Graz – Firma & Anbieter',
    h1Title: '3D-Druck Graz – Ihre 3D-Druck Firma für Designmodelle & Prototypen',
    metaTitle: '3D-Druck Graz Firma & Anbieter | Service via A9 | ekdruck',
    metaDescription: '3D-Druck Graz ✓ Professioneller 3D-Druck Anbieter & Dienstleister ✓ Designmodelle, Konzeptstudien, Gehäuse-Prototypen ✓ Express via A9 ✓ Angebot in 6h → Jetzt anfragen',
