...
export const regionalDruckData: Record<string, RegionalDruckData> = {
  ...
  'wels': {
    ...
    metaDescription: '3D-Druck direkt neben Wels: Persönliche Abholung in 10 Min. Designmodelle, Präsentationsobjekte & Einzelstücke. Same-Day möglich – jetzt anfragen!',
