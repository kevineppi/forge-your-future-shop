...
export const regionalDruckData: Record<string, RegionalDruckData> = {
  ...
  'niederoesterreich': {
    ...
    metaTitle: '3D Druck Niederösterreich – KMU & Agrartechnik | ekdruck',
    metaDescription: 'NÖ-Gewerbebetriebe & Agrartechnik: Konzeptmodelle, Schablonen & Weinbau-Zubehör ab 1 Stück. A1-Lieferung in 5–7 Tagen. Jetzt anfragen.',
  ...
  'steiermark': {
    ...
    metaTitle: '3D Druck Steiermark – Green Tech & TU Graz | ekdruck',
    metaDescription: 'Steirische Forschung & Industrie: Konzeptmodelle für Energiesysteme, TU-Studienarbeiten & Demonstrationsmodelle. Express via A9. Jetzt anfragen.',
  ...
  'kaernten': {
    ...
    metaTitle: '3D Druck Kärnten – Holzindustrie & Tourismus | ekdruck',
    metaDescription: 'Kärntner Holz- & Tourismusbetriebe: Verbindungsstudien, Displayobjekte & Gehäusemodelle. Robuster Versand über A10. Angebot in 6h.',
  ...
  'vorarlberg': {
    ...
    metaTitle: '3D Druck Vorarlberg – Export-Industrie & Design | ekdruck',
    metaDescription: 'Vorarlberger Exportbetriebe: Textilmaschinen-Studien, Beschlagmodelle & Kunststoff-Mockups. Auch Lieferung in die Schweiz. Angebot in 6h.',
  ...
  'burgenland': {
    ...
    metaTitle: '3D Druck Burgenland – Agrar, Wein & Energie | ekdruck',
    metaDescription: 'Burgenlands Landwirtschaft & Energiebranche: PV-Montage-Studien, Weinbau-Displays & Agrartechnik-Modelle. Via Wien/A4. Ab €20 anfragen.',
