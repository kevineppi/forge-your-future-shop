...
export const regionalDruckData: Record<string, RegionalDruckData> = {
  ...
  'graz': {
    ...
    metaTitle: '3D-Druck Graz – Anbieter mit Express-Versand über die A9',
    metaDescription: '3D-Druck Anbieter für Graz: Designstudien, Konzeptmodelle und Prototypen drucken lassen. Express via A9, Angebot in 6 Stunden, persönliche Beratung.',
  ...
  'salzburg': {
    ...
    metaTitle: '3D-Druck Salzburg – Anbieter mit A1-Express ab OÖ',
    metaDescription: '3D-Druck Anbieter für Salzburg: Displays, Bühnenmodelle und Produktvisualisierungen drucken lassen. Schnelle A1-Lieferung, Angebot in 6 Stunden.',
  ...
  'innsbruck': {
    ...
    metaTitle: '3D-Druck Innsbruck – Anbieter für Forschung & Sportdesign',
    metaDescription: '3D-Druck Anbieter für Innsbruck: Studienmodelle, Ergonomie-Mockups und Designstudien drucken lassen. 6+ Materialien, Angebot in 6 Stunden.',
  ...
  'klagenfurt': {
    ...
    metaTitle: '3D-Druck Klagenfurt – Anbieter mit A10-Lieferung in 5–7 Tagen',
    metaDescription: '3D-Druck Anbieter für Klagenfurt: Gehäusemodelle, Verbindungsstudien und Produktmockups drucken lassen. Lieferung über A10, Angebot in 6 Stunden.',
