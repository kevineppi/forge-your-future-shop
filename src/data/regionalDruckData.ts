...
export const regionalDruckData: Record<string, RegionalDruckData> = {
  'wien': {
    ...
    metaTitle: '3D-Druck Wien – Anbieter mit Express-Lieferung über Nacht',
    metaDescription: '3D-Druck Anbieter für Wien: Modelle, Prototypen und Architekturmodelle drucken lassen. Express über Nacht, Angebot in 6 Stunden, persönliche Übergabe möglich.',
  ...
  'linz': {
    ...
    metaTitle: '3D-Druck Linz – Same-Day Anbieter, 20 Min vor der Tür',
    metaDescription: '3D-Druck Anbieter für Linz: Same-Day-Service, persönliche Abholung in 20 Minuten Entfernung. Modelle, Prototypen und Schulungsobjekte drucken lassen.',
