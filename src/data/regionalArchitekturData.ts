...
export const regionalArchitekturData: Record<string, RegionalArchitekturData> = {
  'wien': {
    ...
    metaTitle: 'Architekturmodelle Wien | Wettbewerb morgen? ✓ | ekdruck',
    metaDescription: 'Architekturmodelle für Wiener Büros: Wettbewerbsmodelle, Studienmodelle, Stadtplanung. Express in 24h. Ab €20 – Angebot in 6h!',
  ...
  'niederoesterreich': {
    ...
    metaTitle: 'Architekturmodelle NÖ | Express über A1 | ekdruck',
    metaDescription: 'Architekturmodelle für NÖ-Architekten: Einfamilienhäuser, Gemeindebauten, Sanierungen. Schnelle A1-Lieferung. Ab €20 – jetzt anfragen!',
  ...
  'oberoesterreich': {
    ...
    metaTitle: 'Architekturmodelle OÖ | Abholung heute ✓ | ekdruck',
    metaDescription: 'Lokale Fertigung in Gunskirchen: Architekturmodelle für OÖ-Wettbewerbe. Same-Day-Service & persönliche Übergabe. Ab €20 – jetzt anfragen!',
  ...
  'steiermark': {
    ...
    metaTitle: 'Architekturmodelle Steiermark | Express Graz | ekdruck',
    metaDescription: 'Architekturmodelle für steirische Architekten: TU Graz, Wettbewerbe, Smart City. Express über A9. Angebot in 6h – jetzt anfragen!',
  ...
  'kaernten': {
    ...
    metaTitle: 'Architekturmodelle Kärnten | Holzbau-Spezialist | ekdruck',
    metaDescription: 'Architekturmodelle für Kärntner Büros: Holzbau, Tourismusbauten, alpine Architektur. Express über A10. Ab €20 – jetzt anfragen!',
  ...
  'salzburg': {
    ...
    metaTitle: 'Architekturmodelle Salzburg | Schnell über A1 | ekdruck',
    metaDescription: 'Architekturmodelle für Salzburger Architekten: Altstadtsanierungen, Hotels, Wettbewerbe. Express über A1. Angebot in 6h – jetzt anfragen!',
  ...
  'tirol': {
    ...
    metaTitle: 'Architekturmodelle Tirol | Alpine Architektur | ekdruck',
    metaDescription: 'Architekturmodelle für Tiroler Büros: Bergstationen, Hotels, alpine Architektur. Geländemodelle möglich. Ab €20 – jetzt anfragen!',
  ...
  'vorarlberg': {
    ...
    metaDescription: 'Architekturmodelle für Vorarlberger Baukultur: Holzbau, Bregenzerwald, Wettbewerbe. Design-Kompetenz. Angebot in 6h – jetzt anfragen!',
  ...
  'burgenland': {
    ...
    metaTitle: 'Architekturmodelle Burgenland | Express via Wien | ekdruck',
    metaDescription: 'Architekturmodelle fürs Burgenland: Weingut-Architektur, Tourismus, Wohnbau. Lieferung über Wien/A4. Ab €20 – jetzt anfragen!',
  ...
  'linz': {
    ...
    metaTitle: 'Architekturmodelle Linz | Same Day möglich ✓ | ekdruck',
    metaDescription: 'Nur 20 Min entfernt: Architekturmodelle für Linzer Architekturbüros. Wettbewerbsabgabe morgen? Same-Day-Delivery – jetzt anfragen!',
  ...
  'wels': {
    ...
    metaTitle: 'Architekturmodelle Wels | Abholung 10 Min ✓ | ekdruck',
    metaDescription: 'Direkt vor Ort: Architekturmodelle für Welser Architekten. Persönliche Abholung in Gunskirchen. Last-Minute-Service – jetzt anfragen!',
  ...
  'graz': {
    ...
    metaTitle: 'Architekturmodelle Graz | TU Graz & Wettbewerbe | ekdruck',
    metaDescription: 'Architekturmodelle für Grazer Büros: TU Graz Projekte, Altstadtsanierung, Smart City. Express über A9. Angebot in 6h – jetzt anfragen!',
  ...
  'klagenfurt': {
    ...
    metaTitle: 'Architekturmodelle Klagenfurt | Holzbau-Profi | ekdruck',
    metaDescription: 'Architekturmodelle für Klagenfurter Architekten: Seearchitektur, Holzbau, Stadtentwicklung. Express über A10. Ab €20 – jetzt anfragen!',
  ...
  'villach': {
    ...
    metaTitle: 'Architekturmodelle Villach | Express Kärnten | ekdruck',
    metaDescription: 'Architekturmodelle für Villacher Projekte: Tourismusbauten, Wohnbau, Gewerbe. Zuverlässig über A10/A2. Angebot in 6h – jetzt anfragen!',
  ...
  'st-poelten': {
    ...
    metaTitle: 'Architekturmodelle St. Pölten | Schnell via A1 | ekdruck',
    metaDescription: 'Architekturmodelle für St. Pölten: Regierungsviertel, Stadtentwicklung, FH-Projekte. Direkte A1-Lieferung. Ab €20 – jetzt anfragen!',
  ...
  'innsbruck': {
    ...
    metaTitle: 'Architekturmodelle Innsbruck | Alpin-Spezialist | ekdruck',
    metaDescription: 'Architekturmodelle für Innsbrucker Büros: Alpine Architektur, Bergstationen, Uni-Projekte. Geländemodelle möglich. Ab €20 – jetzt anfragen!',
  ...
  'dornbirn': {
    ...
    metaTitle: 'Architekturmodelle Dornbirn | Baukultur VBG | ekdruck',
    metaDescription: 'Architekturmodelle für Dornbirner Architekten: Vorarlberger Baukultur, Holzbau, Wettbewerbe. Design-Kompetenz. Angebot in 6h!',
