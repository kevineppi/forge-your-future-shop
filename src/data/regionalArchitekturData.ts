...
export const regionalArchitekturData: Record<string, RegionalArchitekturData> = {
  ...
  'klagenfurt': {
    ...
    metaTitle: 'Architekturmodelle Klagenfurt – See & Holzbau | ekdruck',
    metaDescription: 'Klagenfurter Architekten: Wörthersee-Architektur, Holzbau-Modelle & Stadtentwicklung. Zuverlässige Alpenlogistik. Angebot in 6h.',
