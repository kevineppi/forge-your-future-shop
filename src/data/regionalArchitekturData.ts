...
export const regionalArchitekturData: Record<string, RegionalArchitekturData> = {
  ...
  'innsbruck': {
    ...
    metaTitle: 'Architekturmodelle Innsbruck – Nordkette & Uni | ekdruck',
    metaDescription: 'Innsbrucker Architekten: Bergstations-Modelle, Uni-Projekte & Topografie-Studien mit Geländedarstellung. Ab €20 – Angebot in 6h.',
